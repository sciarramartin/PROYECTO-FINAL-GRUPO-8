...
const Registro = () => {
    ...
    const añosDeIngreso = Array.from({ length: 25 }, (_, index) => anioActual - index);
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 font-sans">
            <div className="bg-white rounded-2xl shadow-md w-full max-w-md p-10">
                ...
                <h2 className="text-xl font-bold text-center text-gray-900 mb-1">Registro de Usuario</h2>
                <p className="text-sm text-center text-gray-400 mb-7">Creá tu cuenta para continuar</p>
                ...
                {/* Carrera */}
                <div className="mb-4">
                    <label className="block text-xs font-semibold text-gray-600 mb-1.5">Carrera</label>
                    <select
                        value={id_carrera}
                ...
                {/* Año */}
                <div className="mb-4">
                    <label className="block text-xs font-semibold text-gray-600 mb-1.5">Año de ingreso</label>
                    <select
                        value={anio_ingreso}
                    ...
                    >
                        ...
                        {/* Mapeamos el arreglo para renderizar cada año como una opción */}
                        {añosDeIngreso.map((año) => (
