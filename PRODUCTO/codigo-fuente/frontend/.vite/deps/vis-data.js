//#region node_modules/vis-data/peer/esm/vis-data.mjs
/**
* vis-data
* http://visjs.org/
*
...
var _Symbol$1 = /* @__PURE__ */ getDefaultExportFromCjs(/* @__PURE__ */ requireSymbol$1());
...
function requireIterator$5() {
	...
	requireEs_symbol_iterator();
	iterator$5 = (/* @__PURE__ */ requireWellKnownSymbolWrapped()).f("iterator");
	return iterator$5;
}
var iterator$4;
...
function requireIterator$3() {
	...
	iterator$3 = /* @__PURE__ */ requireIterator$4();
	return iterator$3;
}
var iterator$2;
...
var _Symbol$iterator$1 = /* @__PURE__ */ getDefaultExportFromCjs(/* @__PURE__ */ requireIterator$1());
function _typeof(o) {
...
function requireEs_array_unscopables_flatMap() {
	...
	(/* @__PURE__ */ requireAddToUnscopables())("flatMap");
...
function requireFlatMap$3() {
	...
	flatMap$3 = (/* @__PURE__ */ requireGetBuiltInPrototypeMethod())("Array", "flatMap");
	return flatMap$3;
}
var flatMap$2;
...
function requireFlatMap$1() {
	...
	flatMap$1 = /* @__PURE__ */ requireFlatMap$2();
	return flatMap$1;
}
var flatMap;
...
var _flatMapInstanceProperty = /* @__PURE__ */ getDefaultExportFromCjs(requireFlatMap());
/**
...
var _Symbol = /* @__PURE__ */ getDefaultExportFromCjs(requireSymbol());
var es_array_slice = {};
...
function requireEs_reflect_ownKeys() {
	...
	(/* @__PURE__ */ require_export())({
		target: "Reflect",
		stat: true
	}, { ownKeys: /* @__PURE__ */ requireOwnKeys$3() });
...
function requireOwnKeys$2() {
	...
	ownKeys$3 = (/* @__PURE__ */ requirePath()).Reflect.ownKeys;
	return ownKeys$3;
}
var ownKeys$2;
...
function requireOwnKeys$1() {
	...
	ownKeys$2 = /* @__PURE__ */ requireOwnKeys$2();
	return ownKeys$2;
}
var ownKeys$1;
...
var _Reflect$ownKeys = /* @__PURE__ */ getDefaultExportFromCjs(requireOwnKeys());
...
function requireKeys$6() {
	...
	keys$6 = (/* @__PURE__ */ requirePath()).Object.keys;
	return keys$6;
}
var keys$5;
...
var _Object$keys = /* @__PURE__ */ getDefaultExportFromCjs(requireKeys$4());
...
function requireForEach$3() {
	...
	forEach$3 = (/* @__PURE__ */ requireGetBuiltInPrototypeMethod())("Array", "forEach");
	return forEach$3;
}
var forEach$2;
...
function requireForEach$2() {
	...
	forEach$2 = /* @__PURE__ */ requireForEach$3();
	return forEach$2;
}
var forEach$1;
...
var Emitter = /* @__PURE__ */ getDefaultExportFromCjs(/* @__PURE__ */ requireComponentEmitter());
...
function deepObjectAssignNonentry() {
	...
	else if (values.length > 2) return deepObjectAssignNonentry(deepObjectAssign(values[0], values[1]), ..._sliceInstanceProperty(values).call(values, 2));
	const a = values[0];
	const b = values[1];
	...
	for (const prop of _Reflect$ownKeys(b)) if (!Object.prototype.propertyIsEnumerable.call(b, prop));
...
*/
function clone(a) {
	if (_Array$isArray(a)) return _mapInstanceProperty(a).call(a, (value) => clone(value));
...
function stripDelete(a) {
	for (const prop of _Object$keys(a)) if (a[prop] === DELETE) delete a[prop];
...
function requireKeys$3() {
	...
	hasRequiredKeys$3 = 1;
	requireEs_array_iterator();
	keys$3 = (/* @__PURE__ */ requireGetBuiltInPrototypeMethod())("Array", "keys");
	return keys$3;
}
var keys$2;
...
var _keysInstanceProperty = /* @__PURE__ */ getDefaultExportFromCjs(requireKeys());
var es_array_sort = {};
var arraySort;
...
var _Symbol$iterator = /* @__PURE__ */ getDefaultExportFromCjs(requireIterator());
var entries$3;
...
function requireEntries$3() {
	...
	requireEs_array_iterator();
	entries$3 = (/* @__PURE__ */ requireGetBuiltInPrototypeMethod())("Array", "entries");
	return entries$3;
}
var entries$2;
...
function requireEntries$2() {
	...
	entries$2 = /* @__PURE__ */ requireEntries$3();
	return entries$2;
}
var entries$1;
...
var _entriesInstanceProperty = /* @__PURE__ */ getDefaultExportFromCjs(requireEntries());
var byteToHex = [];
...
var Queue = class Queue {
	...
	*/
	static extend(object, options) {
		...
		if (object.flush !== void 0) throw new Error("Target object already has a property flush");
		object.flush = () => {
			queue.flush();
		};
		const methods = [{
		...
		if (options && options.replace) for (let i = 0; i < options.replace.length; i++) {
	...
	destroy() {
		...
		if (this._extended) {
			...
			for (let i = 0; i < methods.length; i++) {
				...
				if (method.original) object[method.name] = method.original;
				else delete object[method.name];
			}
			this._extended = null;
		}
	}
	...
	*/
	_flushIfNeeded() {
		...
		if (this.queue.length > 0 && typeof this.delay === "number") this._timeout = _setTimeout(() => {
			this.flush();
		}, this.delay);
	}
	/**
...
*/
var DataSetPart = class DataSetPart {
	constructor() {
...
function requireGetIterator$5() {
	...
	requireEs_array_iterator();
	requireEs_string_iterator();
	getIterator_1 = /* @__PURE__ */ requireGetIterator$6();
...
function requireGetIterator$3() {
	...
	getIterator$3 = /* @__PURE__ */ requireGetIterator$4();
...
function requireGetIterator$2() {
	...
	getIterator$2 = /* @__PURE__ */ requireGetIterator$3();
...
var _getIterator = /* @__PURE__ */ getDefaultExportFromCjs(requireGetIterator());
/**
* Data stream
* @remarks
...
var DataStream = class DataStream {
	...
	*/
	*[_Symbol$iterator]() {
		for (const [id, item] of this._pairs) yield [id, item];
	}
	/**
	* Return an iterable of key, value pairs for every entry in the stream.
	*/
	...
	*/
	*keys() {
		for (const [id] of this._pairs) yield id;
	}
	/**
	* Return an iterable of values in the stream.
	*/
	*values() {
		for (const [, item] of this._pairs) yield item;
	}
	/**
	...
	*/
	toObjectMap() {
		...
		for (const [id, item] of this._pairs) map[id] = item;
		return map;
	}
	/**
	...
	*/
	distinct(callback) {
		const set = new _Set();
		for (const [id, item] of this._pairs) set.add(callback(item, id));
		return set;
	}
	/**
	...
	*/
	filter(callback) {
		...
		return new DataStream({ *[_Symbol$iterator]() {
			for (const [id, item] of pairs) if (callback(item, id)) yield [id, item];
		} });
	}
	/**
	...
	*/
	forEach(callback) {
		for (const [id, item] of this._pairs) callback(item, id);
	}
	/**
	...
	*/
	map(callback) {
		const pairs = this._pairs;
		return new DataStream({ *[_Symbol$iterator]() {
			for (const [id, item] of pairs) yield [id, callback(item, id)];
		} });
	}
	/**
	...
	*/
	reduce(callback, accumulator) {
		for (const [id, item] of this._pairs) accumulator = callback(accumulator, item, id);
		return accumulator;
	}
	/**
	* Sort the items.
...
function _objectSpread(e) {
	for (var r = 1; r < arguments.length; r++) {
		...
		r % 2 ? _forEachInstanceProperty(_context8 = ownKeys(Object(t), true)).call(_context8, function(r) {
			_defineProperty(e, r, t[r]);
		}) : _Object$getOwnPropertyDescriptors ? _Object$defineProperties(e, _Object$getOwnPropertyDescriptors(t)) : _forEachInstanceProperty(_context9 = ownKeys(Object(t))).call(_context9, function(r) {
...
function ensureFullItem(item, idProp) {
	if (item[idProp] == null) item[idProp] = v4();
	return item;
}
/**
* # DataSet
...
var DataSet = class extends DataSetPart {
	...
	*/
	constructor(data, options) {
		...
		if (data && data.length) this.add(data);
		this.setOptions(options);
	}
	/**
	* Set new options.
	...
	*/
	add(data, senderId) {
		...
		if (_Array$isArray(data)) {
			...
			if (_someInstanceProperty(idsToAdd).call(idsToAdd, (id) => this._data.has(id))) throw new Error("A duplicate id was found in the parameter array.");
	...
	*/
	update(data, senderId) {
		...
		if (_Array$isArray(data)) for (let i = 0, len = data.length; i < len; i++) if (data[i] && typeof data[i] === "object") addOrUpdate(data[i]);
		else console.warn("Ignoring input item, which is not an object at index " + i);
		else if (data && typeof data === "object") addOrUpdate(data);
		else throw new Error("Unknown dataType");
		if (addedIds.length) this._trigger("add", { items: addedIds }, senderId);
	...
	*/
	updateOnly(data, senderId) {
		var _context;
		if (!_Array$isArray(data)) data = [data];
	...
	get(first, second) {
		...
		if (id != null) {
			...
			if (item && filter && !filter(item)) item = void 0;
		} else if (ids != null) for (let i = 0, len = ids.length; i < len; i++) {
		...
		if (options && options.order && id == void 0) this._sort(items, options.order);
		if (options && options.fields) {
			const fields = options.fields;
			if (id != void 0 && item != null) item = this._filterFields(item, fields);
			else for (let i = 0, len = items.length; i < len; i++) items[i] = this._filterFields(items[i], fields);
		}
		if (returnType == "Object") {
			...
			return result;
		} else if (id != null) return item !== null && item !== void 0 ? item : null;
		else return items;
	}
	/** @inheritDoc */
	getIds(options) {
		...
		if (filter) if (order) {
			...
			for (let i = 0, len = items.length; i < len; i++) ids.push(items[i][this._idProp]);
		} else for (let i = 0, len = itemIds.length; i < len; i++) {
			const id = itemIds[i];
			const item = this._data.get(id);
			if (item != null && filter(item)) ids.push(item[this._idProp]);
		}
		else if (order) {
			const items = [];
			for (let i = 0, len = itemIds.length; i < len; i++) {
			...
			if (item != null) ids.push(item[this._idProp]);
		}
		return ids;
	}
	/** @inheritDoc */
	...
	forEach(callback, options) {
		...
		if (options && options.order) {
			...
			const id = itemIds[i];
			const item = this._data.get(id);
			if (item != null && (!filter || filter(item))) callback(item, id);
		}
	}
	/** @inheritDoc */
	...
	*/
	_filterFields(item, fields) {
		var _context3;
		if (!item) return item;
		return _reduceInstanceProperty(_context3 = _Array$isArray(fields) ? fields : _Object$keys(fields)).call(_context3, (filteredItem, field) => {
	...
	*/
	_sort(items, order) {
		...
		} else if (typeof order === "function") _sortInstanceProperty(items).call(items, order);
	...
	*/
	_remove(id) {
		let ident;
		if (isId(id)) ident = id;
		else if (id && typeof id === "object") ident = id[this._idProp];
	...
	*/
	clear(senderId) {
		...
		const items = [];
		for (let i = 0, len = ids.length; i < len; i++) items.push(this._data.get(ids[i]));
		this._data.clear();
		this.length = 0;
	...
	*/
	distinct(prop) {
		...
		for (let i = 0, len = itemIds.length; i < len; i++) {
			const id = itemIds[i];
			const value = data.get(id)[prop];
			let exists = false;
			for (let j = 0; j < count; j++) if (values[j] == value) {
				exists = true;
				break;
			}
	...
	*/
	_addItem(item) {
		...
		if (this._data.has(id)) throw new Error("Cannot add item: item with id " + id + " already exists");
	...
	*/
	_updateItem(update) {
		...
		const item = this._data.get(id);
		if (!item) throw new Error("Cannot update item: no item with id " + id + " found");
	...
	stream(ids) {
		if (ids) {
			...
			return new DataStream({ *[_Symbol$iterator]() {
				for (const id of ids) {
					const item = data.get(id);
					if (item != null) yield [id, item];
				}
			} });
		} else {
			var _context7;
			return new DataStream({ [_Symbol$iterator]: _bindInstanceProperty(_context7 = _entriesInstanceProperty(this._data)).call(_context7, this._data) });
		}
	}
};
/**
...
* @typeParam IdProp - Name of the property that contains the id.
*/
var DataView = class DataView extends DataSetPart {
	/** @inheritDoc */
	get idProp() {
	...
	*/
	setData(data) {
		if (this._data) {
			...
			const ids = this._data.getIds({ filter: _filterInstanceProperty(this._options) });
	...
	*/
	refresh() {
		...
		for (let i = 0, len = oldIds.length; i < len; i++) {
			const id = oldIds[i];
			const item = this._data.get(id);
			if (item == null) console.error("If you see this, report it please.");
			else if (!newIds[id]) {
				removedIds.push(id);
				removedItems.push(item);
				this._ids.delete(id);
		...
		if (addedIds.length) this._trigger("add", { items: addedIds });
		if (removedIds.length) this._trigger("remove", {
			items: removedIds,
			oldData: removedItems
		});
	...
	get(first, second) {
		...
		if (thisFilter && optionsFilter) viewOptions.filter = (item) => {
	...
	getIds(options) {
		if (this._data.length) {
			...
			let filter;
			if (optionsFilter) if (defaultFilter) filter = (item) => {
	...
	forEach(callback, options) {
		if (this._data) {
			...
			const optionsFilter = options && _filterInstanceProperty(options);
			let filter;
			if (optionsFilter) if (defaultFilter) filter = function(item) {
				return defaultFilter(item) && optionsFilter(item);
			};
			else filter = optionsFilter;
			else filter = defaultFilter;
	...
	stream(ids) {
		var _context4;
		return this._data.stream(ids || { [_Symbol$iterator]: _bindInstanceProperty(_context4 = _keysInstanceProperty(this._ids)).call(_context4, this._ids) });
	}
	/**
	...
	*/
	dispose() {
		...
		for (const key of _Reflect$ownKeys(DataView.prototype)) _Object$defineProperty(this, key, replacement);
	}
	/**
	...
	_onEvent(event, params, senderId) {
		...
		switch (event) {
			...
			case "update":
				for (let i = 0, len = ids.length; i < len; i++) {
					const id = ids[i];
					if (this.get(id)) if (this._ids.has(id)) {
						updatedIds.push(id);
